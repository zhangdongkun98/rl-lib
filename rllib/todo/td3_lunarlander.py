...
from method_td3.td3 import TD3 as Method
...
path_pack, logger = cu.basic.create_dir(config, 'td3_lunar_lstm')
...
def main():
    ...
    for i_episode in range(1, max_episodes + 1):
        ...
        for _ in range(200):
            ...
            if a_loss != None: logger.add_scalar('loss/a_loss', a_loss, method.train_step)
