...
class World(object):
    ...
    def restart(self, spawn_point):
        ...
        if self.player is not None:
            ...
            #Town1:
            #spawn_point.location.x = 365
            #spawn_point.location.y = 326
            #spawn_point.location.z += 2.0
            #spawn_point.rotation.roll = 0
            #spawn_point.rotation.pitch = 0
            #spawn_point.rotation.yaw = 180
            #Town2:
            #spawn_point.location.x = 176
            #spawn_point.location.y = 302
            #spawn_point.location.z += 2.0
            #spawn_point.rotation.roll = 0
            #spawn_point.rotation.pitch = 0
            #spawn_point.rotation.yaw = 180
            # Town3:
            #spawn_point.location.x = 232.5
            #spawn_point.location.y = -25.1
            #spawn_point.location.z += 2.0
            #spawn_point.rotation.roll = 0
            #spawn_point.rotation.pitch = 0
