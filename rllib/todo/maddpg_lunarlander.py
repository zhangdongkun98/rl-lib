...
from method_maddpg.maddpg import MADDPG as Method
...
path_pack, logger = cu.basic.create_dir(config, 'maddpg_lunar')
...
def main():
    ...
    for i_episode in range(1, max_episodes + 1):
        ...
        for _ in range(200):
            ...
            logger.add_scalar('loss/a_loss', a_loss[0], method.train_step)
